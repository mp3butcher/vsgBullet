...
#ifndef OSGBT_WORLD_IMPORTER_H
#define OSGBT_WORLD_IMPORTER_H


#include "btWorldImporter.h"
class osgbtBulletWorldImporter:public btBulletWorldImporter
{
public:

    osgbtBulletWorldImporter(btDynamicsWorld* world=0):	btBulletWorldImporter( world) {}
