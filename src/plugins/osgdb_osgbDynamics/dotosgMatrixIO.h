...
// callable by any code in the osgdb_vsgbDynamics plugin. These functions
// should be in am osgWorks shared library, as they are unfortunately not
// available in shared form in OSG itself.

bool readMatrix( vsg::mat4& matrix, osgDB::Input& fr, const char* keyword="Matrix" );

bool writeMatrix( const vsg::mat4& matrix, osgDB::Output& fw, const char* keyword="Matrix" );
