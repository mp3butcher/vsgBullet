...
: _state(nullptr), _ready(false), _enableFiltering(filtering), _enableRotation(rotation)
{
...
bool P5Glove::updateHandState( vsgbInteraction::HandNode* hn )
{
	...
	vsgbInteraction::HandNode::AllParams currentGloveState;
