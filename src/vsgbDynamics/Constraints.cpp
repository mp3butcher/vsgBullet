...
void SliderConstraint::createConstraint()
{
    if( _rbA == NULL )
    {
        std::cerr << "createConstraint: _rbA == NULL." << std::endl;
        return;
    }
    ...
    const vsg::vec3& axis, const vsg::vec3& point )
{
    ...
    {
        std::cerr << "InternalSpringCreate: _rbA == NULL or _rbB == NULL." << std::endl;
        return( NULL );
    }
...
void CardanConstraint::createConstraint()
{
    ...
    {
        std::cerr << "createConstraint: _rbA == NULL or _rbB == NULL." << std::endl;
        return;
    }
