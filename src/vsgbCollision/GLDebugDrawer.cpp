...
namespace osgbCollision
{
	...
	void GLDebugDrawer::drawLine(const btVector3& from, const btVector3& to, const btVector3& color)
	{
        ...
        vsg::vec3 osgFrom = osgbCollision::asOsgvec3(from);
        vsg::vec3 osgTo = osgbCollision::asOsgvec3(to);
    ...
    /*	if ((vsg::absolute< double >(osgFrom[0]) > bigValue) ||
		...
		vsg::Vec4 c = osgbCollision::asOsgVec4(color, 1.);
	...
	void GLDebugDrawer::drawTriangle(const btVector3& a, const btVector3& b, const btVector3& c, const btVector3& color, btScalar alpha)
	{
		...
		vsg::Vec4 c4 = osgbCollision::asOsgVec4(color, alpha);
