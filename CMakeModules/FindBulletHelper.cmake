...
set_property( CACHE BulletInstallType PROPERTY STRINGS "Default Installation" "Alternate Install Location")
# "Source And Build Tree" ) #problem finding bulletextras includes
...
#
set( VSGBULLET_USE_DOUBLE_PRECISION FALSE CACHE BOOL "Select to force compiling with -DBT_USE_DOUBLE_PRECISION." )
if( _needToFindBullet AND BULLET_FOUND )
    ...
    if( _result )
        message( STATUS "Bullet double precision detected. Automatically defining BT_USE_DOUBLE_PRECISION for vsgBullet." )
        set( VSGBULLET_USE_DOUBLE_PRECISION ON CACHE BOOL "" FORCE )
    else()
        ...
        if( _result )
            message( STATUS "Bullet single precision detected. Not defining BT_USE_DOUBLE_PRECISION for vsgBullet." )
            set( VSGBULLET_USE_DOUBLE_PRECISION OFF CACHE BOOL "" FORCE )
        else()
