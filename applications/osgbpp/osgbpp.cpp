...
int main( int argc, char* argv[] )
{
    ...
    {
        std::cerr << osgbCollision::getVersionString() << std::endl;
    ...
    vsg::ref_ptr< osgbCollision::AbsoluteModelTransform > amtRoot( new osgbCollision::AbsoluteModelTransform );
    ...
    if( rb == NULL )
    {
        std::cerr << "osgbpp: NULL rigid body." << std::endl;
        return( 1 );
    }
