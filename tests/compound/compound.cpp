...
btRigidBody* createBTCompound( osg::MatrixTransform* obj,
                              osg::Vec3 center )
{
    btCollisionShape* collision = vsgbCollision::btTriMeshCollisionShapeFromOSG( obj );
    ...
    osg::Node* n = vsgbCollision::osgNodeFromBtCollisionShape( collision );
    obj->addChild( n );
                   ...
                   btDynamicsWorld * dynamicsWorld )
{
    ...
    btCollisionShape * collision = vsgbCollision::btBoxCollisionShapeFromOSG( target );
          ...
          char * argv[] )
{
    ...
    vsgbCollision::RefBulletObject< btRigidBody >* animRB =
        new vsgbCollision::RefBulletObject< btRigidBody >( animBody );
    animObj->setUserData( animRB );

    vsgbDynamics::RigidBodyAnimation * rba = new vsgbDynamics::RigidBodyAnimation;
