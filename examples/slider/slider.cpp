...
vsg::Transform* makeDrawer( btDiscreteDynamicsWorld* bw/*, osgbInteraction::SaveRestoreHandler* srh*/, vsg::Node* node, const vsg::mat4& m )
{
...
//    vsg::ref_ptr< osgbInteraction::SaveRestoreHandler > srh = new        osgbInteraction::SaveRestoreHandler;
    ...
    vsg::Node* groundRoot = osgbDynamics::generateGroundPlane( plane,
