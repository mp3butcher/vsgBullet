...
#include <mutex>
#ifndef __VSGBDYNAMICS_TRIPLEBUFFER_H__
#define __VSGBDYNAMICS_TRIPLEBUFFER_H__ 1
...
/** \class TripleBuffer TripleBuffer.h <vsgbDynamics/TripleBuffer.h>
...
*/
class VSGBDYNAMICS_EXPORT TripleBuffer
{
public:
    ...
    used by the MotionState to update the matrix of the VSG Transform node it manages.
    ...
    */
    unsigned int reserve( unsigned int size, char* data=nullptr );
...
// __VSGBDYNAMICS_TRIPLEBUFFER_H__
#endif
