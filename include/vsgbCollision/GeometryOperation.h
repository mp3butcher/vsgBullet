...
/** \brief Base class for performing operations on vsg::Geometry objects in collaboration
...
We've created an infrastructure that allows generic operations on an vsg::Geometry object.
...
\c DecimatorDemo-reducer \c dectest32.vsg

<em>Comparing ReducerOp to DecimatorOp</em>

The ReducerOp removes vertices by removing indexes from the VSG PrimitiveSet, and does not
