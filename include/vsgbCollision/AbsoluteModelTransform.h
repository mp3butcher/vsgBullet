...
#ifndef __osgbCollision_ABSOLUTE_MODEL_TRANSFORM_H__
#define __osgbCollision_ABSOLUTE_MODEL_TRANSFORM_H__
...
*/
class OSGBCOLLISION_EXPORT AbsoluteModelTransform : public vsg::Transform
{
public:
    ...
    //META_Node( osgbCollision, AbsoluteModelTransform );
