...
#ifndef __VSGBCOLLISION_BOUNDINGCYLINDER_H__
#define __VSGBCOLLISION_BOUNDINGCYLINDER_H__
...
/** \class BoundingCylinder BoundingCylinder.h <vsgbCollision/BoundingCylinder.h>
\brief Used internally to store cylinder parameters.

TBD Consider not encapsulating parameters in a class. */
class VSGBCOLLISION_EXPORT BoundingCylinder
{
public:
...
// __VSGBCOLLISION_BOUNDINGCYLINDER_H__
#endif
