...
/** \class SaveRestoreHandler SaveRestoreHandler.h <vsgbInteraction\SaveRestoreHandler.h>
...
public:
    ...
    */
    ...
    void add( const std::string& id, vsgbDynamics::CreationRecord* cr );
    ...
    */
    vsgbDynamics::PhysicsData* getPhysicsData( const std::string& id );
    ...
    */
    ...
    models. */
    void setLaunchHandler( vsgbInteraction::LaunchHandler* lh ) { _lh = lh; }
